...
abstract class SnapchatAgent {
	...
	/*
	 * Snapchat version (as of 2013-11-20). Before updating this value, confirm
	 * that the library requests everything in the same way as the app.
	 */
	const VERSION = '4.1.07';

	/*
	 * The API URL. Use the /bq endpoint, the one that the iPhone
	 * uses. Android uses the /ph endpoint.
	 */
	...
	/**
	 * Default cURL options. UA doesn't matter, so why not use Android.
	 */
